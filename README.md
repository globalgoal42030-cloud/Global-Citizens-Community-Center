...
| `room-run-for-office.html` | Run For Office |
...
| `gccc-planner.html` | GCCC Advanced Planner — Field Edition; in-browser go-bag planner (atlas, measurements, kit checklist, tools, calendar, journal), linked from the Adult, Kids, and Pet sections of `virtual-glowbag.html` |
