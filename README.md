...
open gccc-unified/gccc-unified.html
```
...
```bash
npx serve .
# then visit http://localhost:3000/gccc-unified.html
```
...
```
gccc-unified.html        ← Everything. One file.
README.md
```
