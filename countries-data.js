/* GCCC — UN Member States data (193 countries)
   Shared across all room pages. Flags are rendered from ISO 3166-1 alpha-2 codes. */
const UN_COUNTRIES = [
...
{name:"Democratic People's Republic of Korea",code:"KP"},{name:"Democratic Republic of the Congo",code:"CD"},
...
{name:"Republic of Korea",code:"KR"},{name:"Romania",code:"RO"},{name:"Russian Federation",code:"RU"},
...
{name:"Venezuela",code:"VE"},{name:"Viet Nam",code:"VN"},{name:"Yemen",code:"YE"},
